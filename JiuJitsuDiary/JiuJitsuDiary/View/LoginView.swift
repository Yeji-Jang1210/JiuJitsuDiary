...
struct LoginView: View {
    ...
    @State var isForgotPasswordViewPresented: Bool = false
    ...
    var body: some View {
        ZStack {
            ...
            .fullScreenCover(isPresented: $isJoinViewPresented, content: {
                SignUpView()
                    .environmentObject(viewModel)
            })
            .fullScreenCover(isPresented: $isForgotPasswordViewPresented, content: {
                ForgotPasswordView()
            })
            .padding()
        }
